    ...
    <div class="footer-container">
        ...
        <div class="footer-links">
            ...
            <ul>
                ...
                <li><a href="#menu">Menu Kukis</a></li>
                <li><a href="#about">Tentang Kami</a></li>
                <li><a href="#testimonial">Review Pelanggan</a></li>
            </ul>
        </div>
        ...
        <div class="footer-contact">
            ...
            <div class="contact-item">
                <span>📍</span>
                <p>Jl. Mawar Merah No. 12, Jember, Jawa Timur</p>
            </div>
            <div class="contact-item">
                <span>📞</span>
            ...
            <div class="contact-item">
                <span>📧</span>
                <p>hello@crumbleandco.id</p>
            </div>
        </div>
    </div>

    <div class="footer-bottom">
        <p>© <?= date('Y') ?> <strong><?= htmlspecialchars($shop_name) ?></strong>. Dibuat dengan 💕 di Jember.</p>
    </div>
</footer>

<a href="https://wa.me/6281234567890" class="wa-float" target="_blank" title="Chat WhatsApp">
